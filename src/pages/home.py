...
In the following scenarios, you can interact with a LLM using different prompting strategies and see how it affects the model's performance on an IR task.
The LLM used in this demo is [Llama-3.1](https://arxiv.org/pdf/2407.21783) with 8 billion parameters, unless stated otherwise.
